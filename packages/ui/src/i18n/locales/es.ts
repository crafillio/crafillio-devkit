...
export const messages: PartialMessages = {
  ...
  network: {
    ...
    verifyTls: 'Verificar certificados TLS', clientCerts: 'Certificados de cliente',
  },
  about: { title: 'Acerca de', creator: 'Creador y responsable', visitPortal: 'Visitar el portal',
